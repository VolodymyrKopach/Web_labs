...
function addFanAppeal() {
    ...
    let appealObj = new AppealObj(fanAppeal);
    ...
    if (fanAppeal.trim() === "") {
        ...
        if (isOnline()) {
            ...
            pzk.innerHTML += " <div class=\"card col-sm-12 col-lg-12 mt-3\" id=\"appeal\">\n" +
                "                <div class=\"card-body\" >\n" +
                "                    <p class=\"card-text\">" + appealObj.appeal + "</p>\n" +
                "                    <div class=\"row\">\n" +
